    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temperature', models.FloatField(default=0.0, help_text='Temperature', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
                ...
                ('frequency_penalty', models.FloatField(default=0.0, help_text='Frequency Penalty', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
                ('presence_penalty', models.FloatField(default=0.0, help_text='Frequency Penalty', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
